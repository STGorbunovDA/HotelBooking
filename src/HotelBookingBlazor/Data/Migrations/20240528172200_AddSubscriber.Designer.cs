...
namespace HotelBookingBlazor.Migrations
{
    ...
    [Migration("20240528172200_AddSubscriber")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelBookingBlazor.Data.Entities.Amenity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelBookingBlazor.Data.Entities.Enquiry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime>("EnquiredOn")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("HotelBookingBlazor.Data.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HotelBookingBlazor.Data.Entities.Subscriber", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime>("SubscriberOn")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("HotelBookingBlazor.Data.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("HotelBookingBlazor.Data.Entities.Room", "Room")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelBookingBlazor.Data.Entities.Payment", b =>
                {
                    b.HasOne("HotelBookingBlazor.Data.Entities.Booking", "Booking")
                        .WithMany()
